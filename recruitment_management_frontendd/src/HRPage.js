  ...
  const [jobs, setJobs] = useState([
    {
      ...
      candidates: [
        { name: "Emily Davis", experience: "2 years", round: 1, status: "Applied" },
        { name: "Michael Brown", experience: "1 year", round: 1, status: "Applied" },
      ],
    },
    {
      title: "QA Tester",
      ...
      candidates: [
        { name: "Sarah Wilson", experience: "3 years", round: 1, status: "Applied" },
        { name: "David Lee", experience: "2 years", round: 1, status: "Applied" },
      ],
    },
  ]);
    ...
    <div style={styles.page}>
      ...
      <div style={styles.mainContent}>
        ...
        <nav style={styles.navbar}>
          <h2 style={styles.brand}>HR Dashboard</h2>
          <div>
